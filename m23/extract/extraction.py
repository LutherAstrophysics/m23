...
def extractStars(imageData, referenceLogFileName, saveAs, imageName=None, radiusOfExtraction=5):
    ...
    with open(saveAs, "w") as fd:
        ...
        for starIndex in range(len(starsFluxes)):
            ...
            ###
            data = (
                starsCentersInNewImage[starIndex][::-1]
                + (0, 0, 0)
                + starsFluxes[starIndex][1:]
                + (0, 0)
            )
            fd.write(
                f"{data[0]:>16.2f}{data[1]:>16.2f}{data[2]:>16.4f}{data[3]:>16.4f}{data[4]:>16.4f}{data[5]:>16.2f}{data[6]:>16.2f}{data[7]:>16.1f}{data[8]:>16.2f}"
            )
            fd.write("\n")
