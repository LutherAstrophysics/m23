...
axes[0, 0].imshow(source, cmap='gray', interpolation='none', origin='lower', vmin=1500, vmax=4000)
axes[0, 0].axis('off')
axes[0, 0].set_title("Source Image")

axes[0, 1].imshow(target, cmap='gray', interpolation='none', origin='lower', vmin=1500, vmax=4000)
axes[0, 1].axis('off')
axes[0, 1].set_title("Target Image")

axes[1, 1].imshow(registered, cmap='gray', interpolation='none', origin='lower', vmin=1500, vmax=4000)
